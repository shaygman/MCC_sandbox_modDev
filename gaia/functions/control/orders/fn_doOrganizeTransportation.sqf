		...
		{
			{
			   ...
			   then
			   {
			   			switch(_TransportClass) do
					{
							...
							case "Car":
								{ _dummy= [_group,_TransportGrp] call GAIA_fnc_doTransportCar;};
							case "Tank":
								{ _dummy= [_group,_TransportGrp] call GAIA_fnc_doTransportTank;};
							case "Helicopter":
								{ _dummy= [_group,_TransportGrp] call GAIA_fnc_doTransportHelicopter;};
							case "Ship":
