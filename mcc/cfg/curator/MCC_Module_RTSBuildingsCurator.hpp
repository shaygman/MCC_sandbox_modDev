class MCC_Module_RTSBuildingsCurator : MCC_Module_Base
{
	scope = 2;
	isGlobal = 1;
	scopeCurator = 2;
	category = "MCC_RTS";
	displayName = "Create Building";
	function = "MCC_fnc_curatorRTSBuilding";
	portrait = "a3\ui_f\data\GUI\Cfg\RespawnRoles\support_ca.paa";
	icon = "a3\ui_f\data\GUI\Cfg\RespawnRoles\support_ca.paa";
	picture = "a3\ui_f\data\GUI\Cfg\RespawnRoles\support_ca.paa";
