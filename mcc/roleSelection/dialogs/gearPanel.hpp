class CP_GEARPANEL {
	...
	class controls
	{
		...
		class CP_deployPanelMiniMapBckg: CP_RscListBox
		{
			idc = 1005;
			...
			onMouseButtonDown = __EVAL("['MouseButtonDown',_this] execVM '"+CPPATH+"mcc\roleSelection\scripts\camMouseMoving.sqf'");
			onMouseButtonUp = __EVAL("['MouseButtonUp',_this] execVM '"+CPPATH+"mcc\roleSelection\scripts\camMouseMoving.sqf'");
		};
		...
		class CP_rolesList: MCC_RscControlsGroup
		{
			idc = 2302;
			x = 0.0101562 * safezoneW + safezoneX;
		...
		class CP_armorProgress: MCC_RscProgress
		{
			idc = 201;
		...
		class CP_loadProgress: MCC_RscProgress
		{
			idc = 202;
			x = 0.0410937 * safezoneW + safezoneX;
			y = 0.951 * safezoneH + safezoneY;
		...
		class CP_weightProgress: MCC_RscProgress
		{
			idc = 203;
			x = 0.0410937 * safezoneW + safezoneX;
			y = 0.973 * safezoneH + safezoneY;
