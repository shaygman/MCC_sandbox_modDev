...
class MCC_keyBindsGroup: MCC_RscControlsGroup
{
	...
	class controls
	{
		class MCC_keyBindsOpenMCCtext: MCC_RscText
		{
			...
			text = $STR_Open_MCC; //--- ToDo: Localize;
		...
		class MCC_keyBindsOpenConsoletext: MCC_RscText
		{
			...
			text = $STR_Comm_Console; //--- ToDo: Localize;
		...
		class MCC_keyBindsOpenGroupstext: MCC_RscText
		{
			...
			text = $STR_SQ_DIAL; //--- ToDo: Localize;
			x = 0.00515597 * safezoneW;
			y = 0.176 * safezoneH;
			w = 0.0973958 * safezoneW;
			h = 0.0219914 * safezoneH;
		...
		class MCC_keyBindsMCCinteractiontext: MCC_RscText
		{
			...
			text = $STR_Interact; //--- ToDo: Localize;
			x = 0.00515597 * safezoneW;
			y = 0.209 * safezoneH;
			w = 0.0973958 * safezoneW;
			h = 0.0219914 * safezoneH;
		...
		class MCC_keyBindsMCCinteractionSelftext: MCC_RscText
		{
			...
			text = $STR_Interact_Self; //--- ToDo: Localize;
			x = 0.00515597 * safezoneW;
			y = 0.242 * safezoneH;
			w = 0.0973958 * safezoneW;
			h = 0.0219914 * safezoneH;
		...
		{
			idc = 8499;
			tooltip = $STR_Disable_Client;
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			text = $STR_MCC_DISABLED; //--- ToDo: Localize;
