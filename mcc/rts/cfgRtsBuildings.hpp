class MCC_rts_hq1
{
	...
	actions[] = {"MCC_rts_rtsBuildUIContainer","MCC_rts_rtsFortUIContainer","MCC_rts_addArtilleryAmmo","MCC_rts_evacHelicopterBuy","MCC_rts_scanResourcesBasic","","MCC_rts_scanResourcesCancel",""};
	fortifications[] = {"MCC_rts_fortSandbagLong","MCC_rts_fortSandbagRound","MCC_rts_fortRazorwire"};
	missionsBasic[] = {"MCC_rts_missionsSupplyRun","MCC_rts_missionPatrol","MCC_rts_missionsIntel"};
	missionsAdvanced[] = {"MCC_rts_missionsDestroy","MCC_rts_missionsHVT","MCC_rts_missionsIED","MCC_rts_missionsCapture"};
	constType = "hq";
	level = 1;
	resources[] = {};
...
class MCC_rts_hq2 : MCC_rts_hq1
{
	...
	actions[] = {"MCC_rts_rtsBuildUIContainer","MCC_rts_rtsFortUIContainer","MCC_rts_addArtilleryAmmo","MCC_rts_evacHelicopterBuy","MCC_rts_scanResourcesBasic","MCC_rts_scanResourcesAdvanced","","MCC_rts_scanResourcesCancel"};
	level = 2;
...
class MCC_rts_barracks1
{
	...
	constType = "barracks";
	level = 1;
	resources[] = {{"repair",200},{"food",400},{"med",200},{"time",3}};
	actionFNC = "MCC_fnc_baseActionClicked";
...
class MCC_rts_barracks2 : MCC_rts_barracks1
{
	...
	constType = "barracks";
	level = 2;
	resources[] = {{"repair",400},{"food",600},{"med",200},{"time",3}};
...
class MCC_rts_barracks3 : MCC_rts_barracks1
{
	...
	constType = "barracks";
	level = 3;
	resources[] = {{"repair",600},{"food",800},{"med",200},{"time",3}};
...
class MCC_rts_tradepost1
{
	...
	constType = "tradePost";
	level = 1;
	resources[] = {{"ammo",600},{"repair",600},{"fuel",600},{"time",3}};
	actionFNC = "MCC_fnc_baseActionClicked";
...
class MCC_rts_workshop1
{
	...
	constType = "workshop";
	level = 1;
	resources[] = {{"ammo",200},{"repair",600},{"fuel",200},{"time",3}};
	actionFNC = "MCC_fnc_baseActionClicked";
...
class MCC_rts_workshop2 : MCC_rts_workshop1
{
	...
	upgradeTo[] = {};
	level = 2;
	resources[] = {{"ammo",400},{"repair",600},{"fuel",400},{"time",3}};
	actionFNC = "MCC_fnc_baseActionClicked";
...
class MCC_rts_workshop3 : MCC_rts_workshop2
{
	...
	upgradeTo[] = {};
	level = 3;
	resources[] = {{"ammo",800},{"repair",800},{"fuel",800},{"time",3}};
...
class MCC_rts_workshop4 : MCC_rts_workshop2
{
	...
	upgradeTo[] = {};
	level = 4;
	resources[] = {{"ammo",1600},{"repair",1000},{"fuel",1600},{"time",3}};
...
class MCC_rts_workshop5 : MCC_rts_workshop2
{
	...
	upgradeTo[] = {};
	level = 5;
	resources[] = {{"ammo",2000},{"repair",1200},{"fuel",2000},{"time",3}};
...
class MCC_rts_elecPower1
{
	...
	constType = "elecPower";
	level = 1;
	resources[] = {{"repair",400},{"fuel",200},{"time",3}};
	actionFNC = "MCC_fnc_baseActionClicked";
...
class MCC_rts_elecPower2 : MCC_rts_elecPower1
{
	...
	constType = "elecPower";
	level = 2;
	resources[] = {{"repair",800},{"fuel",400},{"time",3}};
...
class MCC_rts_elecPower3 : MCC_rts_elecPower1
{
	...
	constType = "elecPower";
	level = 3;
	resources[] = {{"repair",1200},{"fuel",200},{"time",3}};
...
class MCC_rts_triage1
{
	...
	constType = "triage";
	level = 1;
	resources[] = {{"repair",500},{"food",200},{"med",500},{"time",3}};
	actionFNC = "MCC_fnc_baseActionClicked";
	objectsArray[] =  {};
};
...
class MCC_rts_triage2
{
	...
	constType = "triage";
	level = 2;
	resources[] = {{"repair",800},{"food",400},{"med",800},{"time",3}};
	actionFNC = "MCC_fnc_baseActionClicked";
	objectsArray[] =  {};
};
