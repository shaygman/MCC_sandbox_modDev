...
_keyUp = (findDisplay 312) displayAddEventHandler  ["KeyUp", "if (_this select 3) then {missionNamespace setvariable ['MCC_ctrlPressed',false]}"];
_keyDown = (findDisplay 312) displayAddEventHandler  ["KeyDown", "if ((_this select 3) && !(missionNamespace getvariable ['MCC_ctrlPressed',false])) then {missionNamespace setvariable ['MCC_ctrlPressed',true]}"];
...
_str = "<t size='0.8' t font = 'puristaLight' color='#FFFFFF'>" + "Hold Ctrl to disable MCC edit" + "</t>";
