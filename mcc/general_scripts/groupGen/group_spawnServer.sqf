			...
			case 1:
				{
					...
					_unit = [[_safepos select 0,_safepos select 1,0], 0, _unitClass, _group] call MCC_fnc_spawnVehicle;
				};
			case 2:
				{
					_safepos  =[_pos,1,100,2,_waterSpawn,100,0] call BIS_fnc_findSafePos;
					_unit = [[_safepos select 0,_safepos select 1,300], 0, _unitClass, _group] call MCC_fnc_spawnVehicle;
				};
			};
		};
